...
object EnableBonusCardDefaults {
     ...
     * @param switchCheckedThumb Thumb color when switch is checked.
     * @param switchUncheckedThumb Thumb color when switch is unchecked.
     * @param switchCheckedTrack Track color when switch is checked.
     * @param switchUncheckedTrack Track color when switch is unchecked.
     * @param switchCheckedBorder Border color when switch is checked.
     * @param switchUncheckedBorder Border color when switch is unchecked.
     */
    ...
    fun colors(
        ...
        switchCheckedThumb: Color = System.color.iconWhite,
        switchUncheckedThumb: Color = System.color.iconWhite,
        switchCheckedTrack: Color = System.color.buttonActive,
        switchUncheckedTrack: Color = System.color.iconDisabled,
        switchCheckedBorder: Color = System.color.buttonActive,
        switchUncheckedBorder: Color = System.color.iconDisabled
        ...
        switchCheckedBorder = switchCheckedBorder,
        switchUncheckedBorder = switchUncheckedBorder
    )
        ...
        Row(
            ...
            Switch(
                ...
                colors = SwitchDefaults.colors(
                    ...
                    checkedBorderColor = colors.switchCheckedBorder,
