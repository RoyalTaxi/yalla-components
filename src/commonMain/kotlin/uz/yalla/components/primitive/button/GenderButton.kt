...
import uz.yalla.components.model.common.Gender
 ...
 *
 * @property gender Gender option to display.
...
object GenderButtonDefaults {
    ...
    @Composable
    fun style(
        label: TextStyle = System.font.body.base.medium
    ) = GenderButtonStyle(
        label = label
    )
...
fun GenderButton(
    ...
    Button(
        ...
        Row(
            ...
            Text(
                text = state.gender.resource?.let { res -> stringResource(res) }.orEmpty(),
                color = colors.text,
                style = style.label
            )
