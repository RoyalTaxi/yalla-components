...
/**
 * Default values and factory functions for [SecondaryButton].
 */
object SecondaryButtonDefaults {
    ...
    /** Minimum width per size variant. */
    ...
    /** Minimum height per size variant. */
    ...
    /** Content padding per size variant. */
     ...
     *
     * @param container Background when enabled.
     * @param content Text/icon when enabled.
     * @param disabledContainer Background when disabled.
     * @param disabledContent Text/icon when disabled.
     */
    @Composable
    fun colors(
