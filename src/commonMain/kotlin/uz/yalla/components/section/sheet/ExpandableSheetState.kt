...
class ExpandableSheetState internal constructor(
    ...
    internal val anchoredDraggableState: AnchoredDraggableState<ExpandableSheetValue> =
 ...
 */
val ExpandableSheetSpringSpec: AnimationSpec<Float> = spring(
 ...
 */
@OptIn(ExperimentalFoundationApi::class)
fun Modifier.expandableSheetDraggable(
    state: ExpandableSheetState,
): Modifier = this.anchoredDraggable(
